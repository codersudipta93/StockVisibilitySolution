...
const RMFGStock = () => {
    ...
    const [customername, setCustomername] = useState('Sudipta Mukherjee');
    const [location, setLocation] = useState('Tata Nagar');
    ...
    const invoiceData = [
        {
            id: '1',
            productType: 'TML POS',
            meterialDescription:"TML SPS E34 TY13 1.90x1250.0x2500",
            grade: 'E46',
            tdc: '-',
            thickness: 2.5,
            width: 1500,
            ...
            id: '2',
            productType: 'TML POS',
            meterialDescription:"TML POS E34 HA11 2.50x1250.0x2500",
            grade: 'E46',
            tdc: '-',
            thickness: 2.5,
            width: 1250,
            ...
            id: '3',
            productType: 'TML SPS',
            meterialDescription:"TML SPS E34 TY13 1.60x1250.0x2500",
            grade: 'E46',
            tdc: '-',
            thickness: 1.6,
            width: 1250,
            ...
            id: '4',
            productType: 'TML POS',
            meterialDescription:"TML POS E34 HB42 3.00x1250.0x2360",
            grade: 'E34',
            tdc: '-',
            thickness: 3,
            width: 1250,
            ...
            id: '5',
            productType: 'TML POS',
            meterialDescription:"TML POS E46 HA29 4.00x1250.0x2500",
            grade: 'E46',
            tdc: '-',
            thickness: 4,
            width: 1250,
            ...
            id: '7',
            productType: 'TML POS',
            meterialDescription:"TML POS E34 TY13 1.90x1250.0x1720",
            grade: 'E46',
            tdc: '-',
            thickness: 1.9,
            width: 1250,
    ...
    const renderItem = ({ item, index }) => (
        <View style={[styles.card, { marginBottom: (index == (invoiceData.length) - 1) ? 29 : 15 }]}>
            {/* Card Header */}
            <View style={styles.cardHeader}>
                <View style={styles.headerLeft}>
                    <Icon name="cube-outline" size={18} color="#fff" />
                    <Text style={styles.invoiceNo}>{item.productType}</Text>
                </View>
                <View style={styles.headerRight}>
                    <Icon name="shield-checkmark" size={16} color="#fff" />
                    <Text style={styles.invoiceDate}>{item.grade}</Text>
                </View>
            </View>
            ...
            <View style={styles.cardContent}>
                <View style={styles.productInfo}>
                    ...
                    <Text style={styles.productType}>{item.meterialDescription}</Text>
                ...
                {expandedCard === index && (
                    <View style={styles.dimensionsContainer}>
                        ...
                        {/* <View style={styles.dimensionItem}>
                            <View style={{ flexDirection: 'row' }}>
                                <Icon name="resize-outline" size={16} color="#6b7280" />
                                <Text style={styles.dimensionLabel}>TDC</Text>
                            </View>
                            <Text style={styles.dimensionValue}>{item.thickness}mm</Text>
                        </View> */}
                    </View>
